...
Some rules appear universal. Others depend on roles, relationships, agreements, capacities, or institutions. A physician may have reasons a stranger lacks. A parent may properly give special attention to their child. A citizen may be governed by a traffic rule that does not apply on another continent.
...
The difficult balance is disciplined revisability. A system that never changes can insulate error. A system that changes whenever insiders are inconvenienced has no stable standard. Correctability asks what may be challenged, by whom, with what evidence, through which procedure, and with what repair after acknowledged failure.
...
> A moral verdict counts as true when __________.

### Stance independence

> The verdict would remain true despite changes in __________, but could depend on __________.

### Scope

> The system addresses __________ because __________.

### Authority

> A rejecting agent has a reason to comply because __________.

### Accessibility

> A sincere inquirer improves their judgment by __________.

### Coherence

> When two principles conflict, the system __________.

### Determinacy

> The system may leave a case unsettled when __________, but not merely when __________.

### Usability

> An ordinary person can apply the system with access to __________.
...
If your rankings differ, do not force them together. The difference shows why metaphysical success and practical desirability need separate columns.
