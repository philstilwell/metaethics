...
The assembly appoints a water-allocation judge. She owns no farm, factory, or waterfront property. Her family receives the same household allotment as everyone else. She discloses every conflict of interest. She applies published standards. She gives reasons for each decision and permits appeal.
...
There is no law requiring one use of the word. The danger lies in asking response dependence to perform two incompatible roles: to ground value in human responsiveness when metaphysical access is challenged, and to claim independence from every response when universal authority is desired.
...
> My Candidate System ceases to count as objective morality if its central verdicts depend constitutively on __________.
